...
parser.add_argument("-w", "--workers", dest="num_workers", type=int, required=True,
                    help="Number of workers to run by server", metavar="num_workers")
parser.add_argument("-k", "--top_k", dest="num_words", type=int, required=True,
                    help="Top K words to calculate", metavar="num_words")
